...
*/
      ...
      { dayjs: 2, "dayjs/plugin/timezone": 3, "dayjs/plugin/utc": 4 },
    ],
    2: [
      function (require, module, exports) {
        !(function (t, e) {
            ...
            (f.tz = function (t, e) {
              ...
              var n = this.utcOffset(),
                ...
                f = o(a, { locale: this.$L })
                  ...
                  .utcOffset(
                    15 * -Math.round(i.getTimezoneOffset() / 15) - u,
                    !0
                  );
              if (e) {
                var s = f.utcOffset();
